...
plt.savefig(OutputDir + "simTICLCand_regrEn_v4_test.png")

plot_ratio_single(numerator, denominator, 10, [1,200], label1="TICLv4", xlabel="Sim Regressend Energy [GeV]", saveFileName=OutputDir + "trackEff_v4_test.png")
